...
| `PostFinanceCheckoutSdk.instance?.launch(token: String, paymentMethodConfigurationId: Int? = null)` | function | Opening payment dialog (activity), paymentMethodConfigurationId is numeric name of payment method or can be null |
